...
> 当前版本：0.14.0。以下保留 2.1.0 与 2.6.0 的历史基线；当前本地 E2E 结果见同目录 `E2E_TEST_REPORT.md`，全项目回归基线见文末更新。
...
0.14.0 的最终离线构建会重新执行发布一致性、构件完整性和便携冒烟验证；构建后的结果以 `docs/releases/RELEASE_REPORT_0.14.0.md` 和版本化 `artifacts/` 目录为准。
