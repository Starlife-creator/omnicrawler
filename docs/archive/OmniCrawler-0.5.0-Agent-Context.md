...
- 版本：0.5.0；Python：3.10+；配置协议：v5；公共 SDK 和 CLI 语义保持兼容。
...
详见 `docs/ARCHITECTURE.md`、`docs/CONFIG_REFERENCE.md`、`docs/GUI_DESIGN_2.1.md`、`docs/OPTIMIZATION_PLAN_FIRST_PRINCIPLES_0.5.0.md` 和 `docs/releases/RELEASE_REPORT_0.5.0.md`。
