...
from omnicrawler.core.logging_utils import configure_logging
...
def test_no_stderr_falls_back_to_stringio(clean_root: None, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("omnicrawler.core.logging_utils._log_file_path", lambda: tmp_path / "logs" / "o.log")
