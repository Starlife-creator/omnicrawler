...
from omnicrawl.core.ai_env import require_ai_privacy, save_ai_config_sidecar
from omnicrawl.core.config import load_config
from omnicrawl.core.errors import AIPrivacyBlockedError
...
def test_compile_with_ai_blocks_without_privacy() -> None:
    ...
    from omnicrawl.services.ai_providers import OpenAICompatibleProvider
    from omnicrawl.services.natural_language_task import compile_with_ai
...
def test_ai_graph_extract_blocks_without_privacy() -> None:
    from omnicrawl.extraction.ai_graph import AIGraphExtractor, FieldDef, Provider
...
def test_adaptive_extractor_blocks_without_privacy(monkeypatch) -> None:
    from omnicrawl.extraction.adaptive_extractor import AdaptiveExtractor
    from omnicrawl.services.ai_providers import OpenAICompatibleProvider
    ...
    monkeypatch.setattr("omnicrawl.services.ai_providers.provider_from_env", lambda **k: provider)
