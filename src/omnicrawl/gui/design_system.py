...
LIGHT = VisualTokens(
    canvas="#F3F7FB", surface="#FFFFFF", elevated="#FFFFFF", nav="#EAF2F7",
    text="#172B3A", muted="#607486",
    border="#DCE6EE", border_strong="#B8CDD9",
    primary="#176B87", primary_hover="#0E7C94", primary_active="#0B5E74",
    selection="#DDF2F5",
    success="#23856D", success_bg="#E3F5EE",
    warning="#B7791F", warning_bg="#FCF3E0",
    danger="#C04444", danger_bg="#FBEAEA",
    info="#176B87", info_bg="#DDF2F5",
    indicator_idle="#B4B4B4", indicator_running="#4CAF50",
    indicator_finished="#2196F3", indicator_error="#F44336",
    code_bg="#1E2730", code_fg="#E6EDF3", code_border="#344957",
    shadow="rgba(23,43,58,0.12)", shadow_overlay="rgba(0,0,0,0.16)", card_shadow="rgba(26,62,78,0.13)",
)

DARK = VisualTokens(
    canvas="#111A22", surface="#192630", elevated="#20313D", nav="#162630",
    text="#EDF5F7", muted="#A6BAC6",
    border="#344957", border_strong="#4A6273",
    primary="#49B4C6", primary_hover="#69C7D5", primary_active="#3A9AAB",
    selection="#24444D",
    success="#54B99B", success_bg="#1A3329",
    warning="#E3B15C", warning_bg="#33291A",
    danger="#EF7777", danger_bg="#33201F",
    info="#49B4C6", info_bg="#1A2E33",
    indicator_idle="#6B7B8A", indicator_running="#54B99B",
    indicator_finished="#49B4C6", indicator_error="#EF7777",
    code_bg="#0D141A", code_fg="#C8D3DC", code_border="#2A3A47",
    shadow="rgba(0,0,0,0.40)", shadow_overlay="rgba(0,0,0,0.55)", card_shadow="rgba(0,0,0,0.30)",
)

HIGH_CONTRAST = VisualTokens(
    canvas="#000000", surface="#000000", elevated="#101010", nav="#000000",
    text="#FFFFFF", muted="#BBBBBB",
    border="#FFFFFF", border_strong="#FFFFFF",
    primary="#FFD600", primary_hover="#FFEA70", primary_active="#CCB500",
    selection="#153BFF",
    success="#00FF85", success_bg="#003319",
    warning="#FFD600", warning_bg="#332B00",
    danger="#FF5252", danger_bg="#330D0D",
    info="#FFD600", info_bg="#332B00",
    indicator_idle="#BBBBBB", indicator_running="#00FF85",
    indicator_finished="#FFD600", indicator_error="#FF5252",
    code_bg="#000000", code_fg="#FFFFFF", code_border="#FFFFFF",
    shadow="rgba(0,0,0,0.6)", shadow_overlay="rgba(0,0,0,0.75)", card_shadow="rgba(0,0,0,0.40)",
)


def theme_tokens(theme: str, *, high_contrast: bool = False, color_blind_friendly: bool = False) -> VisualTokens:
    ...
    return VisualTokens(
        base.canvas, base.surface, base.elevated, base.nav,
        base.text, base.muted, base.border, base.border_strong,
        primary="#0072B2", primary_hover="#56B4E9", primary_active="#00538F",
        selection=selection,
        success="#009E73", success_bg="#D9EFEC",
        warning="#E69F00", warning_bg="#FCEFD3",
        danger="#D55E00", danger_bg="#F5E0D0",
        info="#0072B2", info_bg="#D9EFFB",
        indicator_idle=base.indicator_idle, indicator_running=base.indicator_running,
        indicator_finished=base.indicator_finished, indicator_error=base.indicator_error,
        code_bg=base.code_bg, code_fg=base.code_fg, code_border=base.code_border,
        shadow=base.shadow, shadow_overlay=base.shadow_overlay, card_shadow=base.card_shadow,
    )
...
for _t in (LIGHT, DARK, HIGH_CONTRAST):
    for _f in (_t.canvas, _t.surface, _t.elevated, _t.nav, _t.text, _t.muted,
              _t.border, _t.border_strong, _t.primary, _t.primary_hover, _t.primary_active,
              _t.selection, _t.success, _t.warning, _t.danger, _t.info,
              _t.success_bg, _t.warning_bg, _t.danger_bg, _t.info_bg,
              _t.indicator_idle, _t.indicator_running, _t.indicator_finished, _t.indicator_error,
              _t.code_bg, _t.code_fg, _t.code_border):
...
class ThemeManager:
    ...
    def apply(self, app: QApplication, theme: str, *,
              high_contrast: bool = False, color_blind_friendly: bool = False,
              scale: int = 100) -> VisualTokens:
        """应用主题到 app，并广播令牌变更。"""
        self._app = app
        ...
        app.setProperty("omnicrawlTheme", theme)
        app.setProperty("omnicrawlTokens", tokens)
...
# 向后兼容：保留原函数签名
def apply_design_system(app: QApplication, theme: str, *,
                        high_contrast: bool = False,
                        color_blind_friendly: bool = False) -> VisualTokens:
