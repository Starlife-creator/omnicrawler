...
class SelectionToFieldSpec:
    ...
    def to_omnicrawler_fields(self) -> dict[str, Any]:
    ...
    def to_omnicrawler_yaml(self, seed_url: str = "") -> dict[str, Any]:
        """生成完整的 OmniCrawler 最小 YAML 配置。"""
        fields = self.to_omnicrawler_fields()
        config: dict[str, Any] = {
