...
class AppSettings:
    ...
    # ---- omnicrawler 命令路径 ----
    @property
    def omnicrawler_path(self) -> str:
        return self._value("omnicrawler/path", "omnicrawler", str)

    @omnicrawler_path.setter
    def omnicrawler_path(self, value: str) -> None:
        self._set_value("omnicrawler/path", value)

    @property
    def omnicrawler_version(self) -> str:
        return self._value("omnicrawler/version", "", str)

    @omnicrawler_version.setter
    def omnicrawler_version(self, value: str) -> None:
        self._set_value("omnicrawler/version", value)
