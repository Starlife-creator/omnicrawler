...
⚠ 已废弃：归档安全实现已收敛到 :mod:`omnicrawler.core.archive_security`，
...
def _deprecated() -> None:
    warnings.warn(
        "fetching.archives 已废弃，请改用 omnicrawler.core.archive_security",
        DeprecationWarning,
        stacklevel=3,
    )
...
def safe_extract_archive(
    ...
    *,
    ...
    已废弃（S3.2.2）：归档安全已收敛到 :mod:`omnicrawler.core.archive_security`。
    """
    _deprecated()
